...
class TemperatureMachine(StateMachine):
    ...
    def on_enter_off(self):
        # Turn off both lights when entering the off state
        redLight.off()
        blueLight.off()
    ...
    def processTempStateButton(self):
        ...
        ## Send the cycle event to the state machine
        self.cycle()
    ...
    def processTempIncButton(self):
        ...
        # Update the setPoint and the status lights
        self.setPoint += 1
        self.updateLights()
    ...
    def setupSerialOutput(self):
        # Get the current temperature in Fahrenheit rounded down to the nearest degree
        temp = floor(self.getFahrenheit())
    ...
    def manageMyDisplay(self):
        ...
        while not self.endDisplay:
            ...
            if(altCounter < 6):
                ...
                state_display = self.current_state.id.capitalize()
                lcd_line_2 = f"State:{state_display} {self.setPoint}F"
...
# Grab the button press event and assign it to the function
...
# Assign the button press event to the function to increase the setpoint
...
# Assign the button press event to the function to decrease the setpoint
